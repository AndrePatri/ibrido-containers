...
sudo singularity exec \
    ...
    -B ~/docker/ibrido-docker/conda_hidden:/root/.conda:rw \
    -B ~/docker/ibrido-docker/cache/pip:/root/.cache/pip:rw \
    -B ~/docker/ibrido-docker/cache/isaac-sim/kit:/isaac-sim/kit/cache:rw \
    -B ~/docker/ibrido-docker/cache/isaac-sim/ov:/root/.cache/ov:rw \
