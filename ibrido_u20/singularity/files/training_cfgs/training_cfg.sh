...
export TRAIN_ENV_FNAME="fake_pos_env_baseline" # training env to be loaded in AugMPC
export TRAIN_ENV_CNAME="FakePosEnvBaseline" # name of  traininv class in env file
