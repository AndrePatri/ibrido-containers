...
export MPATH="/root/training_data/d2025_11_12_h23_m34_s38-CentauroCloopANoYawActRepAblation_FakePosEnvBaseline"
export MNAME="d2025_11_12_h23_m34_s38-CentauroCloopANoYawActRepAblation_FakePosEnvBaseline_model"
...
export RNAME="CentauroCloopANoYawSim" # a descriptive base name for this run
...
if [[ $RT_DEPLOY -eq 1 ]]; then
  export CUSTOM_ARGS_NAMES="add_remote_exit_flag step_height control_wheels fixed_flights adaptive_is lin_a_feedback closed_partial use_diff_vels state_from_xbot rt_safety_perf_coeff estimate_v_root add_upper_body use_mpc_pos_for_robot fix_yaw"
  export CUSTOM_ARGS_DTYPE="bool float bool bool bool bool bool bool bool float bool bool bool bool"
  export CUSTOM_ARGS_VALS="true 0.10 true true true false true false true 1.0 false true true true"
  export REMOTE_ENV_FNAME="aug_mpc_envs.envs.rt_deploy_env"
else
  export CUSTOM_ARGS_NAMES="step_height render_to_file render_fps control_wheels fixed_flights adaptive_is lin_a_feedback use_diff_vels xmj_timeout xmj_files_dir state_from_xbot closed_partial fix_yaw add_upper_body"
  export CUSTOM_ARGS_DTYPE="float bool float bool bool bool bool bool int string bool bool bool bool"
  export CUSTOM_ARGS_VALS="0.10 false 60.0 true true true false false $TIMEOUT_MS $HOME/ibrido_ws/src/$XMJ_FILES_DIR true true true true"
