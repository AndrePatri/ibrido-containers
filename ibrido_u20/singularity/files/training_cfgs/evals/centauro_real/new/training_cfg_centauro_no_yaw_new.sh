...
export COMMENT='centauro big wheels no yaw CLOOP partial, real robot' # any training comment
...
export CUSTOM_ARGS_VALS="true 0.10 true true true false true false true 0.965 false false true true"
