...
export MPATH="/root/training_data/d2025_03_11_h20_m27_s40-CentauroCloopANoYawActRepAblation_FakePosEnvBaseline"
...
export RNAME="CentauroCloopANoYawReal" # a descriptive base name for this run
