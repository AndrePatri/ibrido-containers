...
export RNAME="KyonFullyCloopWheelsReal" # a descriptive base name for this run
...
export COMMENT='kyon wheels fully cloop, eval on real robot' # any training comment
...
export CUSTOM_ARGS_VALS="true true false false false $TIMEOUT_MS $HOME/ibrido_ws/src/$XMJ_FILES_DIR false false false true"
