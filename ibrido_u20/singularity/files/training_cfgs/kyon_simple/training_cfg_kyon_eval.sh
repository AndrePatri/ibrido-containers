...
export MPATH="/root/IBRIDO/KyonPartialCloopNoWheelsActRepAblation/d2025_04_01_h16_m49_s27-KyonPartialCloopNoWheelsActRepAblation_FakePosTrackingEnv"
...
export RNAME="KyonFullyCloopNoWheelsReal" # a descriptive base name for this run
...
export COMMENT='kyon no wheels fully cloop, eval on real robot' # any training comment
