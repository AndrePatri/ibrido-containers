...
export COMMENT='centauro big wheels with upper body, ' # any training comment
...
export CUSTOM_ARGS_VALS="false true true false true false true 1.0 false true true"
