...
export COMMENT='kyon no wheels real cloop partial, ' # any training comment
...
if [[ $RT_DEPLOY -eq 1 ]]; then
  ...
  export CUSTOM_ARGS_VALS="true true true true false true false false pelvis false $TIMEOUT_MS $HOME/ibrido_ws/src/$XMJ_FILES_DIR true 1.0 true" 
  ...
  export CUSTOM_ARGS_VALS="false 60.0 true true true true false true false false pelvis false $TIMEOUT_MS $HOME/ibrido_ws/src/$XMJ_FILES_DIR false" 
  export REMOTE_ENV_FNAME="aug_mpc_envs.envs.xmj_env"  
fi
