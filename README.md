...
### 3) Run container
- Navigate to the root folder corresponding to your chosen container (remember to run `export IBRIDO_CONTAINERS_PREFIX=$PWD`, if not already done). You'll notice a `.sif` file.
