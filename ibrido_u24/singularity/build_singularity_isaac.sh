...
if $build_container; then
    ...
    if $use_sudo; then
        ...
        sudo singularity build $IBRIDO_CONTAINERS_PREFIX/ibrido_isaac.sif $IBRIDO_CONTAINERS_PREFIX/u24_isaac.def # either --fakeroot or sudo are necessary
    else
        ...
        singularity build --fakeroot $IBRIDO_CONTAINERS_PREFIX/ibrido_isaac.sif $IBRIDO_CONTAINERS_PREFIX/u24_isaac.def # either --fakeroot or sudo are necessary
