...
Options:
  -s, --use_sudo        Run singularity through sudo.
      ...
      --host <name>     SSH config host alias. Default: ibrido-u24.
...
host_alias="${IBRIDO_VSCODE_SSH_HOST:-ibrido-u24}"
status_only=false
kill_server=false
print_config=false
...
remote_workspace="/root/ibrido_files/ibrido_u24.code-workspace"
