...
export SHM_NS="kyon_simple_no_wheels" # shared mem namespace used for all shared data on CPU
export N_ENVS=800 # number of env to run in parallel
export RNAME="KyonSimplePartialCloopNoWheelsActRepAblation" # a descriptive base name for this run
