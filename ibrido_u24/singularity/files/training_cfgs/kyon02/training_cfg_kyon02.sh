...
export COMMENT='kyon02 no wheels CLOSED partial, UTD 8, action rep 5, target entropy -0.5, fake pos track max 1.0 m/s (action rate, NO CoT, dir track, 1.0 omega weight' # any training comment
...
export CUSTOM_ARGS_VALS="0.12 false true true false true true false true pelvis false"
export SET_ULIM=1
