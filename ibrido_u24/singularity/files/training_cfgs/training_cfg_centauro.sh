...
export SEED=554 # random n generator seed to be used for this run
...
export COMMENT='centauro big wheels CLOSED adaptive, update_freq 8, fake pos env action rate, cot, (only linvel tracking), 0.6 compression, big rpl buffer, huge bsize, 5e-4 lr critic,1e-3 policy, -3.0 trgt entropy' # any training comment
...
export CUSTOM_ARGS_VALS="false true true false false false false true random_patches 0.02"
export SET_ULIM=1 
