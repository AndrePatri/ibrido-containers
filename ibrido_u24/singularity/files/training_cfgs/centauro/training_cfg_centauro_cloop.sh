...
export RNAME="CentauroCloopPartialNoWheels" # a descriptive base name for this run
...
export CUSTOM_ARGS_NAMES="use_jnt_v_feedback step_height rendering_dt control_wheels fixed_flights adaptive_is lin_a_feedback closed_partial estimate_v_root add_upper_body use_flat_ground ground_type dh_ground"
export CUSTOM_ARGS_DTYPE="bool float float bool bool bool bool bool bool bool bool str float "
export CUSTOM_ARGS_VALS="true 0.1 0.1 false true true false true false false true random_patches 0.02"
