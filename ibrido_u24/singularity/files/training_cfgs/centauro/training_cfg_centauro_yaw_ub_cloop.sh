...
export RNAME="CentauroCloopPartialYawUb" # a descriptive base name for this run
...
export COMMENT='centauro big wheels (actuated ankle yaw) with upper body CLOOP, ' # any training comment
...
export JNT_IMP_CONFIG_PATH="${HOME}/ibrido_ws/src/CentauroHybridMPC/centaurohybridmpc/config/jnt_imp_config_yaw_ub_open.yaml" # path to yaml file for jnt imp configuration
if (( $IS_CLOSED_LOOP )); then
  export JNT_IMP_CONFIG_PATH="${HOME}/ibrido_ws/src/CentauroHybridMPC/centaurohybridmpc/config/jnt_imp_config_yaw_ub.yaml"
fi
...
export CUSTOM_ARGS_VALS="false true 0.1 true true true false true false true false false true"
