...
# export MPATH="/root/training_data/AugMPCModels/bundles/centauro/d2026_01_14_h12_m50_s52-CentauroCloopPartialNoYawUbPercep_FakePosTrackEnvPhaseControl"
# export MNAME="d2026_01_14_h12_m50_s52-CentauroCloopPartialNoYawUbPercep_FakePosTrackEnvPhaseControl_model"

export MPATH="/root/training_data/AugMPCModels/bundles/centauro/d2026_01_19_h14_m54_s32-CentauroCloopPartialNoYawUbPercep_FakePosTrackEnvPhaseControl"
...
export SEED=11 # random n generator seed to be used for this run
...
export JNT_IMP_CONFIG_PATH="${HOME}/ibrido_ws/src/CentauroHybridMPC/centaurohybridmpc/config/jnt_imp_config_no_yaw_ub_open.yaml" # path to yaml file for jnt imp configuration
if (( $IS_CLOSED_LOOP )); then
  export JNT_IMP_CONFIG_PATH="${HOME}/ibrido_ws/src/CentauroHybridMPC/centaurohybridmpc/config/jnt_imp_config_no_yaw_ub.yaml"
fi
...
export CUSTOM_ARGS_VALS="0.05 false true 0.1 true true true false true true false false true"
