...
export COMMENT='centauro big wheels with upper body OPEN LOOP,ow using same jnt imp config as robot, action rep 3, gamma 0.98, UTD 4, no entropy annhealing, fake pos track (action rate, CoT, dir track, max_vref 1.0 m/s, max omega 0.4 rad/s,)' # any training comment
...
export CUSTOM_ARGS_NAMES="use_random_pertub use_jnt_v_feedback step_height control_wheels fixed_flights adaptive_is lin_a_feedback closed_partial use_flat_ground estimate_v_root add_upper_body"
export CUSTOM_ARGS_DTYPE="bool bool float bool bool bool bool bool bool bool bool "
export CUSTOM_ARGS_VALS="true false 0.1 false true true false true true false true"
