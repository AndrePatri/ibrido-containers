...
export COMMENT='kyon wheels CLOSED partial, UTD 8, action rep 5, fake pos track (action rate, NO CoT, dir track, max_vref 1.0 m/s), trgt entropy -1.0' # any training comment
...
export CUSTOM_ARGS_VALS="0.1 true true true false true true false false false"
export SET_ULIM=1
