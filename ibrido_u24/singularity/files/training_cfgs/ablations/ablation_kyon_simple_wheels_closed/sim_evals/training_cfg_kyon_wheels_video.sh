...
export MPATH="/root/training_data/d2025_03_23_h21_m47_s57-KyonPartialCloopWheelsSeedAblation_FakePosTrackingEnv"
...
export COMMENT='kyon wheels FULLY CLOSED, UTD 8, action rep 5, fake pos track (action rate, NO CoT, dir track, max_vref 0.8 m/s), trgt entropy -1.0' # any training comment
...
export CUSTOM_ARGS_VALS="0.1 true true true true false true true false false false"
export SET_ULIM=1
