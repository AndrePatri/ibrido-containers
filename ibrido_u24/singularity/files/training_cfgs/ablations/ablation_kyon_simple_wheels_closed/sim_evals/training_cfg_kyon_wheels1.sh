...
export RNAME="KyonPartialCloopWheelsSeedAblation_FakePosTrackingEnv" # a descriptive base name for this run
export SEED=123 # random n generator seed to be used for this run
...
export COMMENT='kyon wheels CLOSED partial, UTD 8, action rep 8, fake pos track (action rate, NO CoT, dir track, max_vref 0.8 m/s), trgt entropy -1.0' # any training comment
...
export JNT_IMP_CONFIG_PATH="${HOME}/ibrido_ws/src/KyonRLStepping/kyonrlstepping/config/jnt_imp_config_open.yaml" # path to yaml file for jnt imp configuration
if (( $IS_CLOSED_LOOP )); then
  export JNT_IMP_CONFIG_PATH="${HOME}/ibrido_ws/src/KyonRLStepping/kyonrlstepping/config/jnt_imp_config.yaml"
fi
...
export CUSTOM_ARGS_VALS="0.1 true true true false true true false false true"
export SET_ULIM=1
