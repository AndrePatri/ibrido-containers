...
export CUSTOM_ARGS_NAMES="use_jnt_v_feedback step_height control_wheels fixed_flights adaptive_is lin_a_feedback closed_partial fix_yaw use_flat_ground estimate_v_root self_collide"
export CUSTOM_ARGS_DTYPE="bool float bool bool bool bool bool bool bool bool bool"
export CUSTOM_ARGS_VALS="false 0.1 true true true false false true true false false"
export SET_ULIM=1
