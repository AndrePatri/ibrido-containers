...
export MPATH="/root/training_data/d2025_03_21_h19_m47_s17-CentauroCloopANoYawActRepAblation_FakePosTrackingEnv/"
export MNAME="d2025_03_21_h19_m47_s17-CentauroCloopANoYawActRepAblation_FakePosTrackingEnv_model"
...
export RNAME="CentauroCloopANoYawActRepAblation" # a descriptive base name for this run
...
export COMMENT='centauro big wheels (fixed ankle yaw) CLOOP adaptive more wheel reg, UTD 16, action rep 5, fake pos track (action rate, CoT, dir track)' # any training comment
...
export JNT_IMP_CONFIG_PATH="${HOME}/ibrido_ws/src/CentauroHybridMPC/centaurohybridmpc/config/jnt_imp_config_open_with_ub.yaml" # path to yaml file for jnt imp configuration
if (( $IS_CLOSED_LOOP )); then
  export JNT_IMP_CONFIG_PATH="${HOME}/ibrido_ws/src/CentauroHybridMPC/centaurohybridmpc/config/jnt_imp_config_with_ub.yaml"
fi
...
export CUSTOM_ARGS_NAMES="rendering_dt render_to_file control_wheels fixed_flights adaptive_is lin_a_feedback closed_partial fix_yaw use_flat_ground estimate_v_root use_gpu"
export CUSTOM_ARGS_DTYPE="float bool bool bool bool bool bool bool bool bool bool"
export CUSTOM_ARGS_VALS="0.1 true true true true false false true true false false"
export SET_ULIM=1
