...
export SEED=188 # random n generator seed to be used for this run
...
export COMMENT='centauro big wheels (fixed ankle yaw) CLOOP adaptive more wheel reg, UTD 16, action rep 1, fake pos track (action rate, CoT, dir track)' # any training comment
