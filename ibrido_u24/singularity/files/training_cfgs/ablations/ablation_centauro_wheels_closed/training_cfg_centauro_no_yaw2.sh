...
export ACTION_REPEAT=10
export USE_SAC=1
export USE_DUMMY=0
export DISCOUNT_FACTOR=0.98
export USE_PERIOD_RESETS=0
export COMMENT='centauro big wheels (fixed ankle yaw) CLOOP adaptive more wheel reg, UTD 16, action rep 10, fake pos track (action rate, CoT, dir track)' # any training comment
