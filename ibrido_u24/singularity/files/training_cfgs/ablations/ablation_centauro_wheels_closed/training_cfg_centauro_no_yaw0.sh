...
export COMMENT='centauro big wheels (fixed ankle yaw) CLOOP adaptive more wheel reg, UTD 16, action rep 3, fake pos track (action rate, CoT, dir track)' # any training comment
