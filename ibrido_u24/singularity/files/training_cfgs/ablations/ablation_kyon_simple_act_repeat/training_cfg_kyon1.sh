...
export COMMENT='kyon no wheels CLOSED partial, UTD 16, action rep 3, fake pos track max 1.0 m/s (action rate, CoT, dir track, 1.0 omega weight)' # any training comment
