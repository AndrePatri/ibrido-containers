...
export RESUME=1 # resume a previous training using a checkpoint

export MPATH="/root/training_data/d2025_10_29_h23_m12_s06-KyonRealPartialCloopNoWheels_FakePosTrackingEnv"
export MNAME="d2025_10_29_h23_m12_s06-KyonRealPartialCloopNoWheels_FakePosTrackingEnv_model"
...
export COMMENT='kyon REAL no wheels CLOSED partiaL - TRAINING RESUME, UTD 8, action rep 5, target entropy -0.5, new MPC tuning, no jnt vel feedback, fake pos track max 1.0 m/s (action rate, CoT, dir track, 1.0 omega weight' # any training comment
