...
export CUSTOM_ARGS_NAMES="use_jnt_v_feedback step_height rendering_dt wheels fixed_flights adaptive_is lin_a_feedback closed_partial use_flat_ground estimate_v_root fully_closed use_gpu control_wheels base_link_name deduce_base_link self_collide"
export CUSTOM_ARGS_DTYPE="bool float float xacro bool bool bool bool bool bool bool bool bool str bool bool"
export CUSTOM_ARGS_VALS="true 0.12 0.1 true true true false true true false false true true base true true"
export SET_ULIM=1
