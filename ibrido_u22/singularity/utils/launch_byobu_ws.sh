...
increase_file_limits_locally 
# clear_terminal
prepare_command "reset && python launch_remote_env.py --headless --use_gpu --remote_stepping --robot_name {} --urdf_path {} --srdf_path {} --jnt_imp_config_path {} --use_custom_jnt_imp --num_envs {}"
