...
export CUSTOM_ARGS_NAMES="control_wheels fixed_flights adaptive_is lin_a_feedback closed_partial use_flat_ground estimate_v_root"
export CUSTOM_ARGS_DTYPE="bool bool bool bool bool bool bool"
export CUSTOM_ARGS_VALS="false true true false false true false"
export SET_ULIM=1 
