...
export CUSTOM_ARGS_NAMES="control_wheels fixed_flights adaptive_is lin_a_feedback closed_partial fix_yaw use_flat_ground"
export CUSTOM_ARGS_DTYPE="bool bool bool bool bool bool bool"
export CUSTOM_ARGS_VALS="true true true false true true true"
export SET_ULIM=1 
