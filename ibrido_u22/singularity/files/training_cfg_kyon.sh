...
export CUSTOM_ARGS_NAMES="wheels fixed_flights adaptive_is lin_a_feedback closed_partial use_flat_ground" 
export CUSTOM_ARGS_DTYPE="xacro bool bool bool bool bool"
