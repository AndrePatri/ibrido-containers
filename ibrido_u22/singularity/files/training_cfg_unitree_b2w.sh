...
export RNAME="FakePosEnvWithDemo" # a descriptive base name for this run
...
export CUSTOM_ARGS_NAMES="wheels fixed_flights adaptive_is lin_a_feedback closed_partial use_flat_ground estimate_v_root base_link_name deduce_base_link" 
export CUSTOM_ARGS_DTYPE="xacro bool bool bool bool bool bool str bool"
export CUSTOM_ARGS_VALS="true true true false true true false base true"
export SET_ULIM=1 
