...
export SEED=12345 # random n generator seed to be used for this run
...
export COMMENT='centauro big wheels CLOSED, linvel env with substep jnt v and est twist, action repeat 5, 10% expl envs, 1:1 coll:update ratio, 0.99 discount factor, 0.8 agent compression' # any training comment
