...
export COMMENT='centauro big wheels CLOSED, update_freq 4, fake pos env var flights (tracking + action rate, all flight control), flat ground, action rep 3, gamma 0.994, 2 layer agent, 1.2 compression' # any training comment
