...
export USE_SAC=1
export DISCOUNT_FACTOR=0.992
export USE_PERIOD_RESETS=0
export COMMENT='centauro big wheels OPEN, action rep 4, gamma 0.992, UTD 16, huge bsize, fake pos env (linvel track DIR + more omega Z reg, CoT, action rate), 3 actor/critic depth 0.6 compression ratio, -0.5 target entropy' # any training comment
