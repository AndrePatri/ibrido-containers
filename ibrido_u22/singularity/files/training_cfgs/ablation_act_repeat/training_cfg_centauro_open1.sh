...
export TOT_STEPS=16000000
export USE_RND=0
export DEMO_ENVS_PERC=0.0
export EXPL_ENVS_PERC=0.0
export ACTION_REPEAT=2
export USE_SAC=1
export DISCOUNT_FACTOR=0.996
export USE_PERIOD_RESETS=0
export COMMENT='centauro big wheels OPEN, action rep 2, gamma 0.996, UTD 16, huge bsize, fake pos env (linvel track DIR + more omega Z reg, CoT, action rate), 3 actor/critic depth 0.6 compression ratio, -0.5 target entropy' # any training comment
