...
export COMMENT='centauro big wheels OPEN, linvel env with substep jnt v and est twist, action repeat 5, 10% expl envs, 1:1 coll:update ratio, 0.99 discount factor, 0.8 agent compression' # any training comment
