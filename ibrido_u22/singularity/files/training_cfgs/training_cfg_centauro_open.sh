...
export SEED=947 # random n generator seed to be used for this run
...
export COMMENT='centauro big wheels, fake pos tracking NO variable flights, 0.8 compression, gamma 0.99, 25:5 update:collection' # any training comment
