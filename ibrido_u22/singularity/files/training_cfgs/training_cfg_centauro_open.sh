...
export SEED=10075 # random n generator seed to be used for this run
export REMOTE_STEPPING=1
export COMPRESSION_RATIO=1.4
...
export COMMENT='centauro big wheels, crazy UTD 32, trying uniform noise patched terrain (with walls), fake pos variable flight length (just track and action rate), big bsize, no expl, 2 layers critic agent, 1.4  compress ratio' # any training comment
...
export CUSTOM_ARGS_VALS="0.1 false true true false true false false false random_patches 0.05"
export SET_ULIM=1 
