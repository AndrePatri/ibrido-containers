...
export SEED=983 # random n generator seed to be used for this run
...
export COMMENT='centauro big wheels, first test with phase based action parametrization (lower action rate penalties), action repeat 5, 10% expl envs, 1:1 coll:update ratio, 0.99 discount factor, 0.8 agent compression' # any training comment
...
export TRAIN_ENV_FNAME="phase_parametrization_baseline"
export TRAIN_ENV_CNAME="PhaseParametrizationBaseline"
