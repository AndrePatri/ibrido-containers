...
export SEED=454998245 # random n generator seed to be used for this run
...
export USE_SAC=1
export DISCOUNT_FACTOR=0.993
export USE_PERIOD_RESETS=1
export COMMENT='kyon no wheels OPEN LOOP, sanity checl (stay still)'
...
export CUSTOM_ARGS_NAMES="rendering_dt wheels fixed_flights adaptive_is lin_a_feedback closed_partial estimate_v_root use_flat_ground ground_type dh_ground" 
export CUSTOM_ARGS_DTYPE="float xacro bool bool bool bool bool bool str float"
export CUSTOM_ARGS_VALS="0.1 false true true false true false true random 0.04"  
export SET_ULIM=1 
