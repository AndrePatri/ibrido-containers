...
export MPATH="/root/training_data/SAC/FakePosEnvVariableFlights/d2025_02_20_h10_m44_s13-FakePosEnvVariableFlights"
export MNAME="d2025_02_20_h10_m44_s13-FakePosEnvVariableFlights_model_checkpoint340"
...
export RNAME="AblationTry" # a descriptive base name for this run
export SEED=442267 # random n generator seed to be used for this run
export REMOTE_STEPPING=1
export COMPRESSION_RATIO=1.2
export ACTOR_LWIDTH=128
export ACTOR_DEPTH=2
export CRITIC_LWIDTH=256
export CRITIC_DEPTH=2
export OBS_NORM=1
...
export COMMENT='centauro big wheels CLOSED, update_freq 4, testing batch norm, adaptive resets, fake pos env var flights (tracking + action rate, all flight control), flat ground, action rep 3, gamma 0.994, 2 layer agent, 1.2 compression' # any training comment
...
export CUSTOM_ARGS_NAMES="control_wheels fixed_flights adaptive_is lin_a_feedback closed_partial estimate_v_root add_upper_body use_flat_ground ground_type dh_ground"
export CUSTOM_ARGS_DTYPE="bool bool bool bool bool bool bool bool str float"
export CUSTOM_ARGS_VALS="false true true false true false false false random_patches 0.04"
export SET_ULIM=1 
