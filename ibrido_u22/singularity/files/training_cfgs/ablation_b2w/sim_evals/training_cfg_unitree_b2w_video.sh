...
export COMMENT='unitree b2w, CLOSED partial, UTD 8, action rep 5, update freq 16, fake pos track (action rate, NO CoT, dir track, max_vref 1.0 m/s), trgt entropy -0.5' # any training comment
...
export CUSTOM_ARGS_NAMES="rendering_dt render_to_file wheels fixed_flights adaptive_is lin_a_feedback closed_partial use_flat_ground estimate_v_root fully_closed use_gpu control_wheels base_link_name deduce_base_link" 
export CUSTOM_ARGS_DTYPE="float bool xacro bool bool bool bool bool bool bool bool bool str bool"
export CUSTOM_ARGS_VALS="0.1 true true true true false true true false false false true base true"
export SET_ULIM=1 
