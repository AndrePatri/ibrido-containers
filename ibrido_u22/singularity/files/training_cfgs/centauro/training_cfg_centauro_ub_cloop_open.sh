...
export RNAME="CentauroOpenPartialUbNoWheels" # a descriptive base name for this run
...
export COMMENT='centauro big wheels OPEN with ub, some random pushes (less frequent), NO entropy annhealing, action rep 3, gamma 0.98, UTD 4, fake pos track (action rate, CoT, dir track, max_vref 1.0 m/s)' # any training comment
