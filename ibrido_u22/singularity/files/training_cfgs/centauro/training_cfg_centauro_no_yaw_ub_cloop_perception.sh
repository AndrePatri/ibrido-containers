...
export CUSTOM_ARGS_NAMES="use_random_pertub use_jnt_v_feedback step_height control_wheels fixed_flights adaptive_is lin_a_feedback closed_partial fix_yaw use_flat_ground estimate_v_root self_collide add_upper_body ground_type"
export CUSTOM_ARGS_DTYPE="bool bool float bool bool bool bool bool bool bool bool bool bool str"
export CUSTOM_ARGS_VALS="true false 0.1 true true true false true true false false false true stairs"
export SET_ULIM=1 
