...
export export DUMP_ENV_CHECKPOINTS=1
...
export CUSTOM_ARGS_NAMES="use_jnt_v_feedback step_height control_wheels fixed_flights adaptive_is lin_a_feedback closed_partial use_flat_ground estimate_v_root add_upper_body"
export CUSTOM_ARGS_DTYPE="bool float bool bool bool bool bool bool bool bool"
export CUSTOM_ARGS_VALS="false 0.1 false true true false true true false true"
export SET_ULIM=1 
