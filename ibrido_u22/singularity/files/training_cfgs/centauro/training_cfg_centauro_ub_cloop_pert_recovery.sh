...
export COMMENT='centauro big wheels CLOSED pert recovery, stronger perturbations with fixed freq, full flight control (also neg), entropy annhealing, bsize 16394, utd 2' # any training comment
