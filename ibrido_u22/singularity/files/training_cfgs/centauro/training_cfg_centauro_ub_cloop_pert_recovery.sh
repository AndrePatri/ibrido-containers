...
export SEED=38312 # random n generator seed to be used for this run
...
export COMMENT='centauro big wheels CLOSED pert recovery, more constant perturbations in magnitude and duration, full flight control, strong perturbations (mx 0.3 weight, more frequent), entropy targets annhealing (disc/cont)' # any training comment
