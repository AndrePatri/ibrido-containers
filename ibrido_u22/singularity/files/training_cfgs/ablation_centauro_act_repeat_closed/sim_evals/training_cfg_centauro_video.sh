...
export CUSTOM_ARGS_NAMES="rendering_dt control_wheels fixed_flights adaptive_is lin_a_feedback closed_partial estimate_v_root add_upper_body use_flat_ground ground_type dh_ground use_gpu"
export CUSTOM_ARGS_DTYPE="float bool bool bool bool bool bool bool bool str float bool"
export CUSTOM_ARGS_VALS="0.1 false true true false true false false true random_patches 0.02 false"
export SET_ULIM=1 
