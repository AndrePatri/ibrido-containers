...
export COMMENT='kyon REAL no wheels CLOSED partial, UTD 8, action rep 5, target entropy -0.5, fake pos track max 1.0 m/s (action rate, CoT, dir track, 1.0 omega weight' # any training comment
