...
export RNAME="B2WPartialCloopWheelsRealBigCoTWithOmegaRand" # a descriptive base name for this run
...
export COMMENT='unitree b2w, CLOSED partial, action rep 5, update freq 16, fake pos track + random ang v. z ref (big omega weight, pof0, action rate, big REAL CoT, max_vref 1.0 m/s), trgt entropy -0.5' # any training comment
