...
export SEED=441 # random n generator seed to be used for this run
...
export COMMENT='kyon no wheels, fake pos tracking with ref VARIABLE FLIGHTS always at 5 m, max 1 m/s, 0.2 cot rew, 50 expl env, gamma 0.995, 512 ep length (15 sec), -1.0 trgt entropy, 8192 bsize, 25:5 update:collection ratio, 1e-3 lrs actor/critic' # any training comment
