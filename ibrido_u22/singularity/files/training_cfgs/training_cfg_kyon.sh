...
export SEED=131 # random n generator seed to be used for this run
...
export COMMENT='kyon no wheels, fake pos tracking with ref always at 5 m, max 1 m/s, testing non-rel exp track reward + linear CoT reward (10:1 ratio), gamma 0.995, 512 ep length (15 sec), -1.0 trgt entropy, 8192 bsize, 25:5 update:collection ratio, 1e-3 lrs actor/critic' # any training comment
