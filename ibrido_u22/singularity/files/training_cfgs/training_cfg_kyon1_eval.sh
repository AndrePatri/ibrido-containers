...
export MPATH="/root/training_data/SAC/KyonFullyCloopNoWheelsActRepAblation_FakePosEnvBaseline/d2025_03_15_h13_m13_s51-KyonFullyCloopNoWheelsActRepAblation_FakePosEnvBaseline"
export MNAME="d2025_03_15_h13_m13_s51-KyonFullyCloopNoWheelsActRepAblation_FakePosEnvBaseline_model"
...
export N_ENVS=32 # number of env to run in parallel
...
export COMMENT='kyon no wheels FULLY CLOSED eval, UTD 16, action rep 5, fake pos track (action rate, CoT, dir track)' # any training comment
...
export CUSTOM_ARGS_VALS="false true false false false true false true" 
export SET_ULIM=1 
