...
export CUSTOM_ARGS_NAMES="rendering_dt control_wheels fixed_flights adaptive_is lin_a_feedback closed_partial fix_yaw use_flat_ground estimate_v_root use_gpu"
export CUSTOM_ARGS_DTYPE="float bool bool bool bool bool bool bool bool bool"
export CUSTOM_ARGS_VALS="0.1 true true true false false true true false false"
export SET_ULIM=1 
