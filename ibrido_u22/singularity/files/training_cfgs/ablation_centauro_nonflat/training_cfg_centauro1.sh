...
export COMMENT='centauro big wheels CLOSED adaptive, random only non flat ground +-0.02 m, action rep 5, fake pos env variable flights (only apex, DIR tracking, CoT, action rate), trgt entropy -0.5' # any training comment
...
export CUSTOM_ARGS_VALS="false true true false false false false false random 0.02"
export SET_ULIM=1 
