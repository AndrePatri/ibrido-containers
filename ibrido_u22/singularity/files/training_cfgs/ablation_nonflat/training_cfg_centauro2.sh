...
export COMMENT='centauro big wheels CLOSED adaptive, random only non flat ground +-0.04 m, action rep 5, fake pos env variable flights (only apex, DIR tracking, CoT, action rate), trgt entropy -0.5' # any training comment
