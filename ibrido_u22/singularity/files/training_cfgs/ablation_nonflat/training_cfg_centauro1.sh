...
export MPATH="/root/training_data/SAC"
export MNAME=""
...
export SEED=15 # random n generator seed to be used for this run
...
export COMMENT='centauro big wheels CLOSED adaptive, random only non flat ground, action rep 5, fake pos env variable flights (only apex, DIR tracking, CoT, action rate), trgt entropy -1.0' # any training comment
...
export CUSTOM_ARGS_VALS="false true true false false false false true random 0.04"
export SET_ULIM=1 
