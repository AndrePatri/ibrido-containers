...
export RNAME="CentauroCLoopPartialNoWheelRealBigCoT" # a descriptive base name for this run
...
export COMMENT='centauro big wheels CLOSED partial, action rep 5, gamma 0.99, UTD 16, huge bsize, fake pos env with omega rand(linvel track DIR + more omega Z reg, BIG CoT but with meas vel norm, action rate), 3 actor/critic depth 0.6 compression ratio, -0.5 target entropy' # any training comment
...
export TIMEOUT_MS=160000 # timeout after which each script autokills ([ms])
