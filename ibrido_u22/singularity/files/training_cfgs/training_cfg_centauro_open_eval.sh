...
export MPATH="/root/training_data/SAC/LinVelTrackBaseline/d2025_02_04_h01_m41_s51-LinVelTrackBaseline"
export MNAME="d2025_02_04_h01_m41_s51-LinVelTrackBaseline_model"
...
export N_ENVS=5 # number of env to run in parallel
export RNAME="" # a descriptive base name for this run
export SEED=765 # random n generator seed to be used for this run
...
export COMMENT='centauro big wheels, linvel env with substep jnt v and est twist, action repeat 5, 10% expl envs, 1:1 coll:update ratio, 0.99 discount factor, 0.8 agent compression' # any training comment
...
export CUSTOM_ARGS_NAMES="control_wheels fixed_flights adaptive_is lin_a_feedback closed_partial use_flat_ground estimate_v_root add_upper_body use_gpu"
export CUSTOM_ARGS_DTYPE="bool bool bool bool bool bool bool bool bool"
export CUSTOM_ARGS_VALS="false true true false true true false false false"
export SET_ULIM=1 
