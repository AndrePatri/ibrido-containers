...
export MPATH="/root/training_data/SAC/FakePosEnvBaseline/d2025_03_06_h10_m09_s31-FakePosEnvBaseline"
export MNAME="d2025_03_06_h10_m09_s31-FakePosEnvBaseline_model"
...
export SEED=986 # random n generator seed to be used for this run
...
export COMMENT='centauro big wheels OPEN eval' # any training comment
