...
export COMMENT='kyon wheels CLOSED partial, UTD 8, action rep 5, fake pos track (action rate, NO CoT, dir track, max_vref 0.8 m/s), trgt entropy -1.0' # any training comment
