...
export RNAME="KyonRealPartialCloopWheelsNoYaw" # a descriptive base name for this run
...
export CUSTOM_ARGS_VALS="0.18 true true true true false true true false pelvis false" 
export SET_ULIM=1 
