...
export RNAME="KyonRealPartialCloopWheels" # a descriptive base name for this run
...
export CUSTOM_ARGS_NAMES="step_height fix_yaw wheels fixed_flights adaptive_is lin_a_feedback closed_partial use_flat_ground estimate_v_root base_linkname self_collide" 
export CUSTOM_ARGS_DTYPE="float bool xacro bool bool bool bool bool bool str bool"
export CUSTOM_ARGS_VALS="0.18 false true true true false true true false pelvis false" 
export SET_ULIM=1 
