...
export RNAME="CentauroOpenNoWheelsBaselineSeedAblation" # a descriptive base name for this run
export SEED=482913 # random n generator seed to be used for this run
...
export COMMENT='centauro big wheels OPEN, seed ablation, UTD 16, huge bsize, fake pos env (linvel track DIR + more omega Z reg, CoT, action rate), 3 actor/critic depth 0.6 compression ratio, -0.5 target entropy' # any training comment
