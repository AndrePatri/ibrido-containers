...
export COMMENT='kyon no wheels FULLY CLOSED, UTD 16, action rep 5, fake pos track (action rate, CoT, dir track small omega weight, max 1 m/s ref, max 7 m ref), 0.5 trgt entropy' # any training comment
