...
export CUSTOM_ARGS_NAMES="step_height fix_yaw wheels fixed_flights adaptive_is lin_a_feedback closed_partial use_flat_ground estimate_v_root use_jnt_v_feedback base_linkname self_collide rendering_dt ground_type enable_height_sensor height_sensor_pixels height_sensor_resolution enable_height_vis height_sensor_forward_offset height_sensor_lateral_offset" 
export CUSTOM_ARGS_DTYPE="float bool xacro bool bool bool bool bool bool bool str bool float str bool int float bool float float"
export CUSTOM_ARGS_VALS="0.10 true true true true false true false false false pelvis false 0.1 stepup_prim true 10 0.16 false 0.0 0.0" 
export SET_ULIM=1 
