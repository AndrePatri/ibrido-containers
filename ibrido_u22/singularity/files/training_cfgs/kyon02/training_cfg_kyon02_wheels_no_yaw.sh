...
export USE_SAC=1
export USE_DUMMY=0
export DISCOUNT_FACTOR=0.95
export USE_PERIOD_RESETS=0
export COMMENT='kyon wheels (no yaw) CLOSED LOOP partial, gamma 0.95, entropy annheal [a bit higher targets], CoT (0.1 scale/ 0.4 offset), self coll, 0.5 yaw rate track, 1.0 max cmd v, 0.5 max cmd omega' # any training comment
