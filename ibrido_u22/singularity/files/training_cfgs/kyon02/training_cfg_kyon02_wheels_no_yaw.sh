...
export COMMENT='kyon wheels (no yaw) CLOSED LOOP partial, gamma 0.98, NO entropy annheal [-0.3, -0.5], CoT [0.1, 0.1], self coll, 1.0 yaw rate track, 1.0 max cmd v, 0.5 max cmd omega' # any training comment
