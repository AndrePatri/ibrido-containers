...
export COMMENT='unitree b2w, CLOSED partial, gamma 0.95, entropy annhealing (d: [-0.05, -0.7], c: [-0.05, -2.0]), max_cmd_v 1.0, max_cmd_omega 0.5, task_track_omega_z_weight 0.5' # any training comment
