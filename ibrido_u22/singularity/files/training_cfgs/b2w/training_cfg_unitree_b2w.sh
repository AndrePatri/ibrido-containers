...
export COMMENT='unitree b2w, CLOSED partial, ' # any training comment
...
export CUSTOM_ARGS_NAMES="rendering_dt wheels fixed_flights adaptive_is lin_a_feedback closed_partial use_flat_ground estimate_v_root fully_closed use_gpu control_wheels base_link_name deduce_base_link self_collide" 
export CUSTOM_ARGS_DTYPE="float xacro bool bool bool bool bool bool bool bool bool str bool bool"
export CUSTOM_ARGS_VALS="0.1 true true true false true true false false true true base true false"
export SET_ULIM=1 
