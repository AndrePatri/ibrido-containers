...
export COMMENT='centauro big wheels (fixed ankle yaw) with upper body OPEN LOOP, fake pos tracking with ref VARIABLE FLIGHTS (len, apex) always at 5 m, max 1 m/s, 1.5 cot rew, 5% expl env, gamma 0.995, 512 ep length (15 sec), -1.0 trgt entropy, 8192 bsize, 25:5 update:collection ratio, 1e-3 lrs actor/critic' # any training comment
