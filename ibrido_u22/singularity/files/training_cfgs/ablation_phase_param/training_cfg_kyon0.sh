...
export RNAME="KyonFullyCloopNoWheelsPhaseParamAblation" # a descriptive base name for this run
export SEED=1928 # random n generator seed to be used for this run
...
export COMMENT='kyon no wheels FULLY CLOSED, UTD 16, action rep 8, fake pos track PHASE PARAM (no flight control, action rate, CoT, dir track)' # any training comment
...
export TRAIN_ENV_FNAME="fake_pos_env_phase_param"
export TRAIN_ENV_CNAME="FakePosEnvPhaseParam"
